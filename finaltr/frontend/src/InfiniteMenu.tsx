...
class InfiniteGridMenu {
  ...
  private init(onInit?: InitCallback): void {
    const gl = this.canvas.getContext("webgl2", {
      antialias: true,
      alpha: true, // Changé de false à true pour activer la transparence
      premultipliedAlpha: false, // Ajouter cette ligne pour une meilleure gestion de l'alpha
    });
    if (!gl) {
  ...
  private render(): void {
    ...
    gl.clearColor(0, 0, 0, 0); // Changé de (0, 0, 0, 1) à (0, 0, 0, 0) pour transparence

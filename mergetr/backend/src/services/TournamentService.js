...
/* TournamentService.js — Service pour gérer les tournois
    ...
    - Notifications et annonces des matchs
    - Validation des règles de jeu uniformes
*/

import pool from '../config/db.js';
import { tournamentNotificationService } from './TournamentNotificationService.js';
...
export class TournamentService {
    ...
    static async registerPlayer(tournamentId, userId = null, alias) {
        ...
        try {
            ...
            // Notifier les autres participants de la nouvelle inscription
            await this._notifyParticipants(client, tournamentId, {
                type: 'player_registered',
                message: `${alias} s'est inscrit au tournoi`,
                data: { alias, participantCount: currentCount + 1 }
            });
    ...
    static async startTournament(tournamentId) {
        ...
        try {
            ...
            // Notifier le début du tournoi et annoncer le premier match
            const firstMatch = await this._getNextMatch(client, tournamentId);
            await this._notifyParticipants(client, tournamentId, {

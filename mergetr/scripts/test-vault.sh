...
# Variables
PROJECT_DIR="/home/midnight/vm_storage/retr/main/mergetr"
...
# Ajout des secrets
add_secret "database" '{"data":{"host":"localhost","port":"5434","user":"admin","password":"test","database":"db_transcendence"}}'
